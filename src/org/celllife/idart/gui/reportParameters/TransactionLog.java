...
/**
 */
public class TransactionLog extends GenericReportGui {
	 ...
	 *            boolean
	 */
	public TransactionLog(Shell parent, boolean activate) {
	...
	protected void createCompHeader() {
		...
		buildCompdHeader(REPORT_TRANSACTION_LOG, icoImage);
	}
	...
	private void createGrpDateRange() {
		...
		grpDateRange.setBounds(new Rectangle(79, 80, 520, 235));
		grpDateRange.setFont(ResourceUtils.getFont(iDartFont.VERASANS_8));
	...
	protected void cmdViewReportWidgetSelected() {
		...
		if (calendarStart.getCalendar().getTime().after(
			...
			TransactionLoggingReport report = new TransactionLoggingReport(
